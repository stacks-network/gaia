declare module 'tape-promise/tape' {
    //import tapeOrig from 'tape'
    //export = tapeOrig

    //import tapeOrig = require('tape')
    //export default tapeOrig
    ...
    namespace tape {
        ...
        interface Test {
            ...
            rejects(fn: PromiseLike, exceptionExpected: RegExp | Function, msg?: string): Promise<void>
        }
    }
